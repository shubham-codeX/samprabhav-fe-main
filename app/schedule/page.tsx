...
const scheduleData: Record<string, Event[]> = {
  day1: [
    {
      ...
      side: "left",
      speaker1:"Mr. Satish Khanna",
      position1:"Chief Guest",
      speaker2:"Dr. Vijay Charlu",
      position2:"Honorary Chairperson",
      speaker3:"Mr. Gagann Atreja",
      position3:"Guest of Honour"
    },
    {
      time: "11:30 AM - 01:00 PM",
      title: "BUCKET 1: Decoding Global Trends Redefining Life Sciences and Technology",
      speaker2: "Mr. Varun Arora",
      position2: "Principal Consultant, Agilisium Consulting",
      speaker1: "Dr. Navneet S Tewatia",
      position1:"Consultant - Policy & Advocacy, Medicines Patent Pool",
      location: "Central Auditorium",
      side: "right",
    },
    {
      ...
      speaker1: "Mr. Aditya Kumar Khanna",
    ...
    },
    {
      ...
      speaker2: "Dr. Someshwar Komuravelly",
      position2 :"Co-Founder and CDO at OrciMed Life Sciences",
      speaker1: "Mr. Hareshh Ratwani",
      position1: "SBU Head - Emerging Pharma Markets/ROW, Esmero Research Pvt. Ltd.",
      location: "Central Auditorium",
      side: "right",
    },
  ],
  ...
  day2: [
    ...
    },
    {
      ...
      position2: "Director-Project Delivery, Octavus Consulting",
      speaker1: "Mr. Abhisek Hiteshi Arora",
      position1: "Project Leader, BCG",
